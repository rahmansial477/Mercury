      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="font-cinzel italic text-base text-[#D1D0D0] tracking-wide font-normal">
              "Lock it Prove it Speak on it"
            </p>
            <p className="text-xs sm:text-sm text-[#D1D0D0] max-w-sm font-normal leading-relaxed">
          ...
          <div className="md:col-span-4 space-y-4">
            <h4 className="font-mono text-xs uppercase tracking-[0.2em] text-[#988686] font-bold">
              Shelby Protocol
            </h4>
            <div className="grid grid-cols-2 gap-3 text-xs font-mono tracking-wider">
              ...
              >
                ...
                <span>Docs</span>
                <ExternalLink className="w-2.5 h-2.5 text-[#988686] group-hover:text-white transition-colors" />
              </a>
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-xs text-[#D1D0D0] font-medium">
                Built by <span className="text-white font-semibold underline decoration-[#988686] underline-offset-4">Rahman</span>
              </p>
              <div className="flex items-center gap-4 text-xs font-mono">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center gap-1 text-[#D1D0D0] hover:text-white transition-colors group"
                >
                  <Github className="w-3.5 h-3.5 text-[#988686] group-hover:text-white transition-colors" />
                  <span>GitHub</span>
                </a>
        ...
        {/* Divider */}
        <div className="w-full h-[1px] bg-[#3e3232]" />

        {/* Bottom Strip */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-mono text-[#D1D0D0]">
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            >
              ...
              <ExternalLink className="w-2.5 h-2.5 text-[#988686]" />
            </a>
          </div>
        ...
        <div className="pt-2 border-t border-[#3e3232]">
          <div className="p-4 bg-[#1F1819] border border-[#988686]/60 rounded-none text-center shadow-md">
            <p className="font-mono text-xs font-semibold uppercase tracking-[0.15em] text-[#D1D0D0] leading-relaxed">
              <span className="text-[#988686] font-bold mr-2">DISCLAIMER ::</span>
